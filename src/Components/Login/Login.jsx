...
export default function Login() {
  ...
  return <>
    ...
    <div className="container py-36 mx-auto px-40 w-3/4">
      <h1 className='text-4xl text-green-600 font-bold text-center mb-8'>Login Now</h1>
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className='flex justify-between items-center'>
          <Link to='/forgetpassword'><button  className='text-green-600 font-semibold'>Forget Your Password ?</button></Link>
          <button type='submit' className='px-16 py-2 bg-green-600 text-white rounded'>
            {isLoading ? <i class="fa-solid fa-spinner fa-spin"></i> : 'Login'}
          </button>
