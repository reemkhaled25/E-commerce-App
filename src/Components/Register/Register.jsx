...
export default function Register() {
  ...
  return <>
    ...
    <div className="container py-32 mx-auto px-40 w-3/4">
      <h1 className='text-4xl text-green-600 font-bold text-center mb-8'>Register Now</h1>
      <form onSubmit={formik.handleSubmit}>
        
        <label htmlFor="name" className='block mb-2 text-green-600 font-semibold'>Enter Your Name :</label>
        ...
        <label htmlFor="email" className='block mb-2 text-green-600 font-semibold'>Enter Your Email :</label>
        ...
        <label htmlFor="password" className='block mb-2 text-green-600 font-semibold'>Enter Your Password :</label>
        ...
        <label htmlFor="repassword" className='block mb-2 text-green-600 font-semibold'>Enter Your Repassword :</label>
        ...
        <div className='text-center'>
          <button type='submit' className='px-16 py-2 bg-green-600 text-white rounded'>
            {isLoading ? <i class="fa-solid fa-spinner fa-spin"></i> : 'Register'}
          </button>
        </div>
